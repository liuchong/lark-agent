.PHONY: build test unit-test integration-test harness-eval install-test lint workflow-lint license-check verify
...
workflow-lint:
	go run github.com/rhysd/actionlint/cmd/actionlint@v1.7.7 \
		.github/workflows/*.yml examples/github-agent/workflows/*.yml
